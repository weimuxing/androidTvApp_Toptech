	...
	int presentationNum = 0;
        try {
             ...
             Method getAC4Presentation = clz.getDeclaredMethod("getAC4Presentation",
                                           new Class[]{});
             Object presentation = getAC4Presentation.invoke(tvAudioManager);
    ...
    public void setAC4Presentation(int index) {
        ...
        try {
             ...
             Method setAC4Presentation = clz.getDeclaredMethod("setAC4Presentation",
                                           new Class[]{int.class});
             Object object = setAC4Presentation.invoke(tvAudioManager, index);
        } catch (Exception e) {
              e.printStackTrace();
        } finally {
        }
    ...
    public void setAC4DialogEnhance(int progress) {
        ...
        try {
             ...
             Method setAC4DialogEnhance = clz.getDeclaredMethod("setAC4DialogEnhance",
                                           new Class[]{int.class});
             Object object = setAC4DialogEnhance.invoke(tvAudioManager, progress);
        } catch (Exception e) {
              e.printStackTrace();
        } finally {
        }
