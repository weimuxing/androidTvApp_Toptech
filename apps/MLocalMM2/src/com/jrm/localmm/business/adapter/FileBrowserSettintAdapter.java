...
/**
 *
 * Provide adapter to viewModePopWindow.
 *
 * @date 2015-02-05
 *
 * @version 1.0.0 *
 ...
 *
 */
public class FileBrowserSettintAdapter extends BaseAdapter{
    ...
    private int[] mItemID = new int[10];

    public FileBrowserSettintAdapter(Context context,ArrayList<ViewMode> viewModeList){
        super();
    ...
    private void createItemID(){
         mItemID[0] = R.layout.filebrowser_setting_popwin_item;
    }
    @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.filebrowser_setting_popwin_item, null);
