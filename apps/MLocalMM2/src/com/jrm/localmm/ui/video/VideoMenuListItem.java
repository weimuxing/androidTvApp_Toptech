...
public class VideoMenuListItem {
	// Picture resource id
	private int icon;
	// Set name
	...
	private int[] optionImageFlag = { R.drawable.item_current,
			R.drawable.item_other, R.drawable.item_other,
			R.drawable.item_other, R.drawable.item_other,
			R.drawable.item_other, R.drawable.item_other,
			R.drawable.item_other, R.drawable.item_other, R.drawable.item_other };

	public VideoMenuListItem(int icon, String settingName, boolean leftArrow,
			String settingOption, boolean rightArrow) {
		this.icon = icon;
	...
	public int[] getOptionImageFlag() {
		return optionImageFlag;
	}
