...
public class BorderTextViews extends TextView {
    ...
    private void drawClip(Canvas canvas) {
        if (this.getText().toString().trim().length()>2) {
            ...
            // top
            canvas.drawLine(3, 0, this.getWidth() - 1, 0, paint);
            // left
            canvas.drawLine(3, 0, 0, this.getHeight() - 1, paint);
            // bottom
            canvas.drawLine(3, this.getHeight() - 1, this.getWidth() - 1,
