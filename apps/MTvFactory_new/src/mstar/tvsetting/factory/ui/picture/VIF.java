...
public class VIF extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTvChannelManager.selectProgram(mTvChannelManager.getCurrentChannelNumber(), TvChannelManager.SERVICE_TYPE_ATV);
	...
	void findView() {
		linearlayout_chinadescrambler_delay = (LinearLayout) findViewById(
				R.id.linearlayout_factory_nonstandard_chinadescrambler_delay);
		...
		text_factory_nonstandard_delay_val = (TextView) this.findViewById(R.id.textview_factory_nonstandard_delay_val);
		...
		case KeyEvent.KEYCODE_DPAD_LEFT:
			...
			case R.id.linearlayout_factory_nonstandard_chinadescrambler_delay:
				if (mChinaAdeDeLayVal > MIN_SCRAMBLE_BOX_DELAY_VAL) {
					...
					text_factory_nonstandard_chinadescrambler_delay_val
							.setText(split((Double.toString(mChinaAdeDeLayUiVal / 10))));
					mTvFactoryManager.setChinaDescramblerBoxDelay(mChinaAdeDeLayVal);
			...
			case R.id.linearlayout_factory_nonstandard_vifcrthr:
				if (mVifCrThreshold > MIN_CR_THR_VAL)
					mVifCrThreshold--;
				this.text_factory_nonstandard_vifcrthr_val.setText(Integer.toHexString(mVifCrThreshold));
			...
			case R.id.linearlayout_factory_nonstandard_vifagcref:
				if (mVifAgcVal > MIN_AGC_REF_VAL)
					mVifAgcVal--;
				this.text_factory_nonstandard_vifagcref_val.setText(Integer.toHexString(mVifAgcVal));
