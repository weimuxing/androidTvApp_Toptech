...
public class PEQAdjustViewHolder {
	...
	protected TextView text_factory_peq_enable_val;
	...
	private final int PEQ_Enable = 1;

	private final int PEQ_Disable = 0;

	private int enableindex;

	private int mBandNum = TvFactoryManager.PEQ_BAND_NUM;
	...
	public PEQAdjustViewHolder(DesignMenuActivity activity) {
		...
		enable = peqActivity.getResources().getStringArray(R.array.str_arr_sound_peq_enable);
	}

	public void findView() {
		text_factory_peq_enable_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_enable_val);
		text_factory_peq_fo1coarse_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo1coarse_val);
		text_factory_peq_fo1fine_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo1fine_val);
		text_factory_peq_fo2coarse_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo2coarse_val);
		text_factory_peq_fo2fine_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo2fine_val);
		text_factory_peq_fo3coarse_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo3coarse_val);
		text_factory_peq_fo3fine_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo3fine_val);
		text_factory_peq_fo4coarse_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo4coarse_val);
		text_factory_peq_fo4fine_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo4fine_val);
		text_factory_peq_fo5coarse_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo5coarse_val);
		text_factory_peq_fo5fine_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_fo5fine_val);
		linearEnable = (LinearLayout) peqActivity.findViewById(R.id.linearlayout_factory_peq_enable);

		text_factory_peq_gain1_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_gain1_val);
		text_factory_peq_gain2_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_gain2_val);
		text_factory_peq_gain3_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_gain3_val);
		text_factory_peq_gain4_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_gain4_val);
		text_factory_peq_gain5_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_gain5_val);
		text_factory_peq_q1_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_q1_val);
		text_factory_peq_q2_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_q2_val);
		text_factory_peq_q3_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_q3_val);
		text_factory_peq_q4_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_q4_val);
		text_factory_peq_q5_val = (TextView) peqActivity.findViewById(R.id.textview_factory_peq_q5_val);
	}

	public void onCreate() {
		mTvFactoryManager = TvFactoryManager.getInstance();

		enableindex = mTvFactoryManager.getPeqEnable(0);
		...
		text_factory_peq_enable_val.setText(enable[enableindex]);
		...
		linearEnable.requestFocus();
	}

	public boolean onKeyDown(int keyCode, KeyEvent event) {
		boolean bRet = true;
		int currentid = peqActivity.getCurrentFocus().getId();
		...
		case KeyEvent.KEYCODE_DPAD_RIGHT:
			switch (currentid) {
			case R.id.linearlayout_factory_peq_enable:
				if (enableindex == 1) {
					enableindex = 0;
					for (int i = 0; i < mBandNum; i++) {
						mTvFactoryManager.setPeqEnable(i, PEQ_Disable);
					}
				} else {
					enableindex++;
					for (int i = 0; i < mBandNum; i++) {
						mTvFactoryManager.setPeqEnable(i, PEQ_Enable);
					}
				}
				text_factory_peq_enable_val.setText(enable[enableindex]);
				break;
		...
		case KeyEvent.KEYCODE_BACK:
			peqActivity.gotoPage(peqActivity.SOUND_PAGE);
			return bRet;
		default:
			bRet = false;
			return bRet;
