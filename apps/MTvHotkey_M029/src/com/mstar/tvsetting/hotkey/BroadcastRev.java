...
public class BroadcastRev extends BroadcastReceiver {
	...
	public static int listViewValue;
	private static boolean isNoSignalAutoSleepFlag = false;
	private static boolean isSetSleepTimeFlag = false;
    ...
    public static boolean getNoSignalAutoSleepFlag()
    {
    	return isNoSignalAutoSleepFlag;
    }
	public static void setNoSignalAutoSleepFlag(boolean flag)
    {
    	isNoSignalAutoSleepFlag=flag;
    }
	public static boolean getSleepTimeFlag()
    {
    	return isSetSleepTimeFlag;
    }
	public static void setSleepTimeFlag(boolean flag)
    {
    	isSetSleepTimeFlag=flag;
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action
            ...
            Log.i(TAG, "com.android.server.tv.TIME_EVENT_LAST_MINUTE_WARN");
            isNoSignalAutoSleepFlag=intent.getBooleanExtra("NoSignalSleep", false);
        }
		//end
        if (action
