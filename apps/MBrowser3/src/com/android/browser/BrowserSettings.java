...
public class BrowserSettings implements OnSharedPreferenceChangeListener,
    ...
    // MStar Android Patch Begin
    private static final String ANDROID_USERAGENT = "Mozilla/5.0 (Linux; " +
        "Android 6.0; MStar Android TV Build/MRA58K; wv) AppleWebKit/537.36 " +
        "(KHTML, like Gecko) Version/4.0 Chrome/48.0.2542.0 Mobile Safari/537.36";

    private static final String IE9_USERAGENT = "Mozilla/5.0 (compatible; " +
        " MSIE 9.0; Windows NT 6.1;Trident/5.0)";

    private static final String FIREFOX7_USERAGENT = "Mozilla/5.0 (Windows NT 6.1; " +
        "Intel Mac OS X 10.6; rv:7.0.1) Gecko/20100101 Firefox/7.0.1";

    private static final String DEFAULT_USERAGENT = "";
    ...
    public static final boolean MEM_OPTIMIZED = true;
    ...
    private void syncSetting(WebSettings settings) {
        ...
        // MStar Android Patch Begin
        //settings.setFullscreenVideoEnabled(enableFullscreenVideo());
        try {
            Method setFullscreenVideoEnabledMethod = settings.getClass().getDeclaredMethod(
                                                     "setFullscreenVideoEnabled",boolean.class);
            Log.d(TAG,"setFullscreenVideoEnabledMethod:"+ setFullscreenVideoEnabledMethod.toString());
            setFullscreenVideoEnabledMethod.invoke(settings,enableFullscreenVideo());
        } catch (NoSuchMethodException e) {
            Log.e(TAG, "Cannot find setFullscreenVideoEnabled() method: " + e);
        } catch (InvocationTargetException e) {
            Log.e(TAG, "Cannot invoke setFullscreenVideoEnabled() method: " + e);
        } catch (IllegalAccessException e) {
            Log.e(TAG, "Cannot access setFullscreenVideoEnabled: " + e);
        }
        // MStar Android Patch End
        ...
        if (ua != null) {
            ...
            // MStar Android Patch Begin
            settings.setUserAgentString(/*USER_AGENTS[getUserAgent()]*/useragentMap.get(getUserAgentName()));
            // MStar Android Patch End
        }
    ...
    private void syncStaticSettings(WebSettings settings) {
        ...
        //settings.enableMemOptimized(MEM_OPTIMIZED);
    }
    ...
    public void onSharedPreferenceChanged(
        ...
        // MStar Android Patch Begin
        } else if (PREF_USERAGENT_STATE.equals(key)) {
			mController.toggleUserAgent();
        // MStar Android Patch End
    ...
    private void initUseragentmap() {
        ...
        useragentMap.put("Default", DEFAULT_USERAGENT);
        useragentMap.put("Desktop", DESKTOP_USERAGENT);
        useragentMap.put("iphone", IPHONE_USERAGENT);
        useragentMap.put("ipad", IPAD_USERAGENT);
        useragentMap.put("Android", ANDROID_USERAGENT);
        useragentMap.put("IE9", IE9_USERAGENT);
        useragentMap.put("Firefox7", FIREFOX7_USERAGENT);
    }
    // MStar Android Patch End
    ...
    public void toggleDesktopUseragent(WebView view) {
        ...
        //MStar Android Patch Begin
        String mUserAgentName = getUserAgentName();
        if (mCustomUserAgents.get(settings) != null) {
            mCustomUserAgents.remove(settings);
            settings.setUserAgentString(/*USER_AGENTS[getUserAgent()]*/useragentMap.get(mUserAgentName));
        } else {
            mCustomUserAgents.put(settings, /*DESKTOP_USERAGENT*/useragentMap.get(mUserAgentName));
            settings.setUserAgentString(/*DESKTOP_USERAGENT*/useragentMap.get(mUserAgentName));
        }
        //MStar Android Patch End
    }
    ...
    public String getUserAgentName() {
        return mPrefs.getString(PREF_USERAGENT_STATE, "Default");
    }
    // MStar Android Patch End
...
// STA extended start.
    public boolean enableVirtualMouse() {
     ...
     public void setVirtualMouseEnabled(boolean value) {
        mPrefs.edit().putBoolean(PREF_VIRTUAL_MOUSE, value).apply();
    }
// STA extended end.
    ...
    public boolean enableFullscreenVideo() {
        return mPrefs.getBoolean(PREF_FULLSCREEN_VIDEO, true);
    }

    public boolean enableTestMode(){
        return mPrefs.getBoolean(PREF_TEST_MODE, false);
    }
    ...
    public int mixedContentMode() {
        return mPrefs.getBoolean(PREF_MIXED_CONTENT, true) ?
