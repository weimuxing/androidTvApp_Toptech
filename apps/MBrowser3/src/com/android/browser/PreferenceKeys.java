...
public interface PreferenceKeys {
    ...
    static final String PREF_USERAGENT_STATE = "useragent_state";
    ...
    static final String PREF_FULLSCREEN_VIDEO = "fullscreen_video";
    static final String PREF_TEST_MODE = "test_mode";
    ...
    // MStar Andoird Patch Begin
    static final String PREF_MIXED_CONTENT = "mixed_content";
    // MStar Android Patch End
