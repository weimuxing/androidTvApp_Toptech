...
public class BrowserHistoryPage extends Fragment
	...
	mChildList.setOnItemSelectedListener(mChildItemSelected);
 ...
 private OnItemSelectedListener mChildItemSelected = new OnItemSelectedListener(){
	@Override
    ...
    /*view.setFocusable(true);
      ...
      view.requestFocus();*/
    mCurrentView = view;
//	Log.i("***selected**","select view is:"+view);
    //Log.i("onItemSelected","this position is:"+positon);
    }
	public void onNothingSelected(AdapterView<?> arg0) {
	//	Log.i("no select","mcurrent is null");
		mCurrentView = null;
		}
 };
    @Override
