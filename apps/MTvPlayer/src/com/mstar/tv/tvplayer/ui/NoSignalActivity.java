...
public class NoSignalActivity extends MstarBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "&&&&&......m_bScreenSaverStatus is :" + m_bScreenSaverStatus);
    ...
    private void redrawComponents() {
        ...
        if ((TvCommonManager.getInstance().getCurrentTvInputSource() == TvCommonManager.INPUT_SOURCE_VGA)
            || (TvCommonManager.getInstance().getCurrentTvInputSource() == TvCommonManager.INPUT_SOURCE_VGA2)
            || (TvCommonManager.getInstance().getCurrentTvInputSource() == TvCommonManager.INPUT_SOURCE_VGA3)) {
    ...
    protected void onNewIntent(Intent intent) {
        Log.d(TAG, "NoSignalActivity onNewIntent");
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_BACK: {
                if (RootActivity.getBackKeyStatus() == false) {
                    Log.d(TAG, " NoSiganlActivity send Cmd_TvApkExit to RootActivity----------");
