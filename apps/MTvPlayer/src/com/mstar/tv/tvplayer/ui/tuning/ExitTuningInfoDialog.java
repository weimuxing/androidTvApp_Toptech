        ...
        if (flag == true)// stop tuning
        {
            switch (mTvChannelManager.getTuningStatus()) {
                ...
                case TvChannelManager.TUNING_STATUS_DTV_SCAN_PAUSING:
                    ...
                    // DVB-T doesn't do this until ChannelTuning receives
                    // DTV_SCAN_STATUS_END event
                    // Because DVB-T may receive SET REGION or other status
                    // after stop scan
                    // DVB-C/ISDB/DTMB also receive DTV_SCAN_STATUS_END after
                    // stopDtvScan
                    // But ATSC seems not
