...
public class SetTimeOffDialogActivity extends MstarBaseActivity {
    ...
    private void findViews() {
        ...
        comboBtnHour = new ComboButton(this, hours, R.id.linearlayout_time_power_off_hour, 1, 2,
            ...
            @Override
            public void doUpdate() {
                Time dateTime = tvTimerManager.getCurrentTvTime();
                dateTime.hour = (byte) (comboBtnHour.getIdx());
                tvTimerManager.setTvOffTimer(dateTime);
                enableOffTimer = true;
        ...
        LinearLayout ll;
        ll = (LinearLayout) findViewById(R.id.linearlayout_time_power_off_switch);
        ll.setOnFocusChangeListener(focusListenser);
        ll = (LinearLayout) findViewById(R.id.linearlayout_time_power_off_hour);
        ll.setOnFocusChangeListener(focusListenser);
        ll = (LinearLayout) findViewById(R.id.linearlayout_time_power_off_minute);
        ll.setOnFocusChangeListener(focusListenser);
    }
    ...
    private void loadDataToUI() {
        ...
        comboBtnHour.setIdx(tvTimerManager.getTvOffTimer().hour);
        int minute = tvTimerManager.getTvOffTimer().minute;
