...
public final class Settings extends InputMethodSettingsFragment
    ...
    public void onCreate(final Bundle icicle) {
        ...
        if (!gestureInputEnabledByBuildConfig) {
            gestureTypingSettings.removePreference(findPreference(PREF_GESTURE_INPUT));
            gestureTypingSettings.removePreference(gesturePreviewTrail);
            gestureTypingSettings.removePreference(gestureFloatingPreviewText);
