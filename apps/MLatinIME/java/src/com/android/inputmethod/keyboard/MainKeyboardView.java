...
public final class MainKeyboardView extends KeyboardView implements PointerTracker.KeyEventHandler,
    ...
    public boolean openMoreKeysKeyboardIfRequired(final Key parentKey) {
        final PointerTracker tracker = PointerTracker.getPointerTracker(0, this);
        tracker.onDownEvent(parentKey.mX, parentKey.mY, SystemClock.uptimeMillis(), this);
    ...
    protected boolean openMoreKeysKeyboardIfRequired(final Key parentKey,
    ...
    public boolean hasMoreKeysPanel() {
        if (mMoreKeysPanel != null) {
            return true;
        } else {
            return false;
