...
public class FactoryDB {
    ...
    public MS_NLA_SETTING queryNonLinearAdjusts() {
        ...
        Cursor cursor = getContentResolver().query(
                ...
                "InputSrcType = " + queryCurInputSrcCM(), null, "CurveTypeIndex");
        int i = 0;
        ...
        try {
            ret = getContentResolver().update(
                    Uri.parse("content://mstar.tv.factory/nonlinearadjust/inputsrctype/"
                            + queryCurInputSrcCM() + "/curvetypeindex/" + curveTypeIndex), vals,
                    null, null);
        } catch (SQLException e) {
        }
        if (ret == -1) {
    ...
    public MS_FACTORY_EXTERN_SETTING queryFactoryExtern() {
        ...
        if (cursor.moveToFirst()) {
			...
			model.onidaviewonoff= cursor.getInt(cursor.getColumnIndex("onidaviewonoff")) == 0 ? false
                   : true;
				// model.onidaviewonoff=true;  
    ...
    public void updateFactoryExtern(MS_FACTORY_EXTERN_SETTING model) {
		...
		vals.put("onidaviewonoff", model.onidaviewonoff ? 1:0);
    ...
    /*
     * Add for queryNonLinearAdjusts()  sky 20151224
     * */
    public int queryCurInputSrcCM() {
        int value  = TvCommonManager.getInstance().getCurrentTvInputSource();
        Log.d("lxk", " 20151224  queryCurInputSrcCM() ="+value);
        return value;
    }
    ...
    public int queryeSoundMode() {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundsetting"),
                null, null, null, null);
        int soundMode = 0;
        if (cursor.moveToFirst()) {
    ...
    public int queryeSpeakerBass(int soundModeType) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundmodesetting/" + soundModeType),
                null, null, null, null);
        int value = 0;
        if (cursor.moveToFirst()) {
            value = cursor.getInt(cursor.getColumnIndex("Bass"));
        }
        cursor.close();
        return value;
    }

    public int queryeSpeakerTreble(int soundModeType) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundmodesetting/" + soundModeType),
                null, null, null, null);
        int value = 0;
        if (cursor.moveToNext()) {
            value = cursor.getInt(cursor.getColumnIndex("Treble"));
        }
        cursor.close();
        return value;
    }
    public int queryeSpeakerEqBand1(int soundModeType) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundmodesetting/" + soundModeType),
                null, null, null, null);
        int value = 0;
        if (cursor.moveToNext()) {
            value = cursor.getInt(cursor.getColumnIndex("EqBand1"));
        }
        cursor.close();
        return value;
    }
    public int queryeSpeakerEqBand2(int soundModeType) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundmodesetting/" + soundModeType),
                null, null, null, null);
        int value = 0;
        if (cursor.moveToNext()) {
            value = cursor.getInt(cursor.getColumnIndex("EqBand2"));
        }
        cursor.close();
        return value;
    }
    public int queryeSpeakerEqBand3(int soundModeType) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundmodesetting/" + soundModeType),
                null, null, null, null);
        int value = 0;
        if (cursor.moveToNext()) {
            value = cursor.getInt(cursor.getColumnIndex("EqBand3"));
        }
        cursor.close();
        return value;
    }
    public int queryeSpeakerEqBand4(int soundModeType) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundmodesetting/" + soundModeType),
                null, null, null, null);
        int value = 0;
        if (cursor.moveToNext()) {
            value = cursor.getInt(cursor.getColumnIndex("EqBand4"));
        }
        cursor.close();
        return value;
    }
    public int queryeSpeakerEqBand5(int soundModeType) {
        Cursor cursor = getContentResolver().query(
                Uri.parse("content://mstar.tv.usersetting/soundmodesetting/" + soundModeType),
                null, null, null, null);
        int value = 0;
        if (cursor.moveToNext()) {
            value = cursor.getInt(cursor.getColumnIndex("EqBand5"));
        }
        cursor.close();
        return value;
    }
