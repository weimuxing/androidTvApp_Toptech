...
public class FactoryDeskImpl implements IFactoryDesk {
    ...
    public int getPicModeValue(int valueMode){
        ...
        Log.d("lxk","-20151223-inPicModeValue[]="+inPicModeValue.toString());
        if(valueMode >= 0)
    ...
    public boolean setOsdV0Nonlinear(int nonlinearVal) {
        ...
        Log.d("lxk","--setOsdV0Nonlinear:" + nonlinearVal + " in type:" + mfactoryNLASet.msNlaSetIndex);
        int setValue = getPicModeValue(typeIndex);
        Log.d("lxk","--setValue:" + setValue);
    ...
    public boolean restoreToDefault() {
		...
		try {
			settingActivity = mContext.createPackageContext("com.mstar.tv.tvplayer.ui",
        ...
        SharedPreferences preferencesSettings = settingActivity.getSharedPreferences(
        		"INPUT_SOURCE", Context.MODE_WORLD_READABLE|Context.MODE_WORLD_READABLE);
	...
	@Override
	public boolean setOnidaviewonoff(boolean isEnable){
		factoryExternSetting.onidaviewonoff = isEnable;
        factoryDB.updateFactoryExtern(factoryExternSetting);
		return true;
	}
	@Override
	public boolean getOnidaviewonoff(){
		return factoryExternSetting.onidaviewonoff;
	}
