...
public class DesignMenuViewHolder {
    ...
    protected LinearLayout linear_factory_aging_mode;

    protected LinearLayout linear_factory_upgrade;

    protected LinearLayout linear_factory_sound;
    
    protected LinearLayout linear_factory_ota_info;
	...
	protected LinearLayout linear_factory_onida;
    
    protected TextView text_factory_onida_val;
    ...
    void findView() {
        ...
        linear_factory_upgrade = (LinearLayout) factoryactivity
                .findViewById(R.id.linear_factory_upgrade_setting);
        linear_factory_aging_mode = (LinearLayout) factoryactivity
                .findViewById(R.id.linearlayout_aging_mode);

        linear_factory_sound = (LinearLayout) factoryactivity
                .findViewById(R.id.linearlayout_factory_sound);
        linear_factory_ota_info = (LinearLayout) factoryactivity
                .findViewById(R.id.linearlayout_ota_info);
				
		text_factory_onida_val=(TextView) factoryactivity
        .findViewById(R.id.textview_factory_onida_val);
			linear_factory_onida=(LinearLayout) factoryactivity
						.findViewById(R.id.linear_factory_onida);
		if(SystemProperties.getBoolean("mstar.cus.onida", false)){
			linear_factory_onida.setVisibility(View.VISIBLE);
		}else{
			linear_factory_upgrade.setNextFocusDownId(R.id.linearlayout_factorymenu);
			linear_factory_menu.setNextFocusUpId(R.id.linear_factory_upgrade_setting);
		}
    }
            ...
            case KeyEvent.KEYCODE_DPAD_RIGHT:
                switch (currentid) {
                    ...
                    case R.id.linearlayout_factory_pqtableupdate:
                        ...
                        break;
					case R.id.linear_factory_onida:
                	 if (SystemProperties.getBoolean("persist.sys.onidaview_onoff", false)) {
                		 ...
                		 text_factory_onida_val.setText("Off");
						FactoryDeskImpl.getInstance(factoryactivity).setOnidaviewonoff(false);
                	 	}else {
                	 		SystemProperties.set("persist.sys.onidaview_onoff", "true");
                	 		text_factory_onida_val.setText("On");
							FactoryDeskImpl.getInstance(factoryactivity).setOnidaviewonoff(true);
						}
                     break;
                    default:
                        break;
