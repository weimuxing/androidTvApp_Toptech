                    ...
                    case R.id.linearlayout_factory_picmode_picmode:
                        ...
                        if (picmodeindex < (maxValue - 1)) {
                           /* if (currentInputSrc == mTvCommonManager.INPUT_SOURCE_VGA
                            ...
                            prePMode = picmodeindex;
                           if(EnableBEE){
                                do{
                                   picmodeindex++;
                                }while(picmodeindex == 0
                                     ||picmodeindex == 4
                                     ||picmodeindex == 5
                                     ||picmodeindex == 6);
                            }else{
                        ...
                        if(EnableBEE && ((prePMode==7 && picmodeindex==8)||(prePMode == 8 && picmodeindex==9))){
                            picModeActivity.sendBroadcast(new Intent("com.android.toptech.bee"));
                        }
            ...
            case KeyEvent.KEYCODE_DPAD_LEFT:
                switch (currentid) {
                    case R.id.linearlayout_factory_picmode_picmode:
                        ...
                        if (picmodeindex > 0) {
                         ...
                         prePMode = picmodeindex;
                           if(EnableBEE){
                                do{
                                    picmodeindex--;
                                    if(picmodeindex<1) picmodeindex = maxValue - 1;
                                }while( picmodeindex == 4
                                         ||picmodeindex == 5
                                         ||picmodeindex == 6
                                         /*||mPicModeIdx == 8*/);
                            }else{
                        ...
                        text_factory_picmode_picmode_val.setText(mPicModeStrArray[picmodeindex]);
                        mTvPictureManager.setPictureMode(picmodeindex);
                         if(EnableBEE && ((prePMode==9 && picmodeindex==8)||(prePMode == 8 && picmodeindex==7))){
                            picModeActivity.sendBroadcast(new Intent("com.android.toptech.bee"));
                        }
                        freshDataToUIWhenPicModChange();
                        break;
