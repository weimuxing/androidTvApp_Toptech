...
public class DesignMenuActivity extends BaseActivity {
    ...
    private TestPatternViewHolder testPatternViewHolder = null;
    ...
    private final int TEST_PATTERN_PAGE = 11;
    ...
    private final int BUTTON_POSITION_TEST_PATTERN_PAGE = 14;
    ...
    private void registerListeners() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    ...
                    case R.id.linearlayout_panel_info:
                        ...
                        break;
                    case R.id.linearlayout_design_testpattern:
                        currentPage = TEST_PATTERN_PAGE;
                        viewFlipper.setDisplayedChild(TEST_PATTERN_PAGE);
                        if (testPatternViewHolder == null) {
                            testPatternViewHolder = new TestPatternViewHolder(
                                    DesignMenuActivity.this);
                    ...
                    case R.id.linearlayout_IP_Enable_Mapping:
                     ...
                     case R.id.linearlayout_factory_ci_setting:
                        ...
                        break;
                    case R.id.linearlayout_factory_excute_shell:
                        Intent newInt = new Intent();
                        newInt.setClass(DesignMenuActivity.this, ExecuteShellActivity.class);
        ...
        designViewHolder.linear_design_testpattern.setOnClickListener(listener);
        ...
        designViewHolder.linear_factory_excute_shell.setOnClickListener(listener);
    }
