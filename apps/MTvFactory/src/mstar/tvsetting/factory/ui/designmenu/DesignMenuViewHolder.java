...
public class DesignMenuViewHolder {
    ...
    protected LinearLayout linear_design_testpattern;
    ...
    protected LinearLayout linear_factory_excute_shell;
    ...
    void findView() {
        ...
        linear_design_testpattern = (LinearLayout) factoryactivity
                .findViewById(R.id.linearlayout_design_testpattern);
        ...
        linear_factory_excute_shell = (LinearLayout) factoryactivity
                .findViewById(R.id.linearlayout_factory_excute_shell);
