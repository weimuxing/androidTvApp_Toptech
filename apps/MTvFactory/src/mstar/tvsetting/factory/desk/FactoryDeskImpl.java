...
public class FactoryDeskImpl implements IFactoryDesk {
    ...
    public boolean setPEQ() {
        ...
        try {//all stPEQParam[].Enable are same value. so reference first. 0 is disable, 1 is enable
            am.enableBasicSoundEffect(EnumSoundEffectType.E_PEQ, factoryPEQSet.stPEQParam[0].Enable == 0 ? false : true);
