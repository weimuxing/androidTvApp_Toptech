...
public class TimePickerDialogFragment extends SafeDismissDialogFragment {
    private static final String TAG = "TimePickerDialogFragment";
    private static final boolean DBG = true;
    private TimePicker mTimePicker;

    public interface ResultListener {
        void done(int hour, int min);
    }

    public static final String DIALOG_TAG = TimePickerDialogFragment.class.getName();

    private String mTitle;
    private int mHour, mMin;
    private ResultListener mListener;

    public TimePickerDialogFragment(String title, int hour, int min, ResultListener listener) {
        mTitle = title;
        mHour = hour;
        mMin = min;
        mListener = listener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = localInflater.inflate(R.layout.time_picker_dialog, container, false);
