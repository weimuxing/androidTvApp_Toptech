...
package com.mstar.tv.ui.sidepanel.item;
...
public abstract class CompoundButtonItem extends Item {
    ...
    public void setChecked(boolean checked) {
        if (isFocused()) {
            if (checked) {
                Tools.speak(R.string.on, false);
            }
            else {
                Tools.speak(R.string.off, false);
            }
        }
        if (mChecked != checked) {
            mChecked = checked;
    ...
    public void onFocused() {
        if (isChecked()) {
            if (mCheckedTitle != null) {
                Tools.speak(mCheckedTitle, true);
            }
            Tools.speak(R.string.on, false);
        }
        else {
            if (mUncheckedTitle != null) {
                Tools.speak(mUncheckedTitle, true);
            }
            Tools.speak(R.string.off, false);
        }
    }
