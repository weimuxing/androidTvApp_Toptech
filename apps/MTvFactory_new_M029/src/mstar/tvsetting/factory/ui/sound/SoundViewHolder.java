...
public class SoundViewHolder {
	...
	private LinearLayout linearlayout_sound_nonlinear;
	...
	public void findView() {
		linearlayout_sound_nonlinear = (LinearLayout) mSoundActivity.findViewById(R.id.linearlayout_sound_nonlinear);
		...
		linearlayout_sound_nonlinear.setOnClickListener(listener);
	...
	private OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View view) {
			switch (view.getId()) {
			case R.id.linearlayout_sound_nonlinear:
				mSoundActivity.gotoPage(mSoundActivity.SOUND_NONLINEAR_PAGE);
				break;
