...
public class ADCAdjustViewHolder {
	private DesignMenuActivity adcActivity;
	...
	private boolean[] mADCSourceItemEnableFlags;
	...
	protected Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			if (msg.what == IFactoryDesk.AUTOTUNE_START) {
				...
				onCreate();
				Toast.makeText(adcActivity,
						adcActivity.getResources().getString(R.string.str_factory_adc_autoadjust_ok),
				...
				onCreate();
				Toast.makeText(adcActivity,
						adcActivity.getResources().getString(R.string.str_factory_adc_autoadjust_failed),
						Toast.LENGTH_SHORT).show();
				...
				onCreate();
				Toast.makeText(adcActivity,
						adcActivity.getResources().getString(R.string.str_factory_adc_autoadjust_timing_mode_err),
						Toast.LENGTH_SHORT).show();
			}
		};
	};

	public ADCAdjustViewHolder(DesignMenuActivity mstarActivity, IFactoryDesk factoryManager) {
		adcActivity = mstarActivity;
		this.factoryManager = factoryManager;

		sourcearrayADC = adcActivity.getResources().getStringArray(R.array.str_arr_picture_adc_vals);
		mADCSourceItemEnableFlags = new boolean[sourcearrayADC.length];
		int[] sourceList = TvCommonManager.getInstance().getSourceList();
		mADCSourceItemEnableFlags[TvFactoryManager.ADC_SET_VGA] = (sourceList[TvCommonManager.INPUT_SOURCE_VGA] == FUNCTION_DISABLED)
				? false : true;
		mADCSourceItemEnableFlags[TvFactoryManager.ADC_SET_YPBPR_SD] = (sourceList[TvCommonManager.INPUT_SOURCE_YPBPR] == FUNCTION_DISABLED)
				? false : true;
		mADCSourceItemEnableFlags[TvFactoryManager.ADC_SET_YPBPR_HD] = (sourceList[TvCommonManager.INPUT_SOURCE_YPBPR] == FUNCTION_DISABLED)
				? false : true;
	...
	public void findView() {
		text_factory_adc_source_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_source_val);
		text_factory_adc_rgain_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_rgain_val);
		text_factory_adc_ggain_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_ggain_val);
		text_factory_adc_bgain_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_bgain_val);
		text_factory_adc_roffset_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_roffset_val);
		text_factory_adc_goffset_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_goffset_val);
		text_factory_adc_boffset_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_boffset_val);
		text_factory_adc_phase_val = (TextView) adcActivity.findViewById(R.id.textview_factory_adc_phase_val);
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			adcActivity.gotoPage(1);
			return bRet;
		case KeyEvent.KEYCODE_MENU:
			adcActivity.returnRoot(0);
	...
	private ProgressDialog getProgressDialog() {
		if (progressDialog == null) {
			...
			progressDialog.setMessage(adcActivity.getString(R.string.str_factory_adc_autoadjust_val));
