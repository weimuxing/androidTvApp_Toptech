...
public class SSCAdjustViewHolder {
	...
	public SSCAdjustViewHolder(DesignMenuActivity activity, IFactoryDesk factoryManager) {
		...
		miuenable = sscActivity.getResources().getStringArray(R.array.str_arr_picture_ssc_miuenable);
		lvdsenable = sscActivity.getResources().getStringArray(R.array.str_arr_picture_ssc_lvdsenable);
		miuenable_u = sscActivity.getResources().getStringArray(R.array.str_arr_picture_ssc_miuenable_u);
		lvdsenable_u = sscActivity.getResources().getStringArray(R.array.str_arr_picture_ssc_lvdsenable_u);
	}

	public void findView() {
		text_factory_ssc_miuenable_val = (TextView) sscActivity.findViewById(R.id.textview_factory_ssc_miuenable_val);
		...
		text_factory_ssc_lvdsenable_val = (TextView) sscActivity.findViewById(R.id.textview_factory_ssc_lvdsenable_val);
	...
	private void checkIsNikeU() {
		...
		// don't show option for nikeU when is not nikeU
		if (!SystemProperties.get("ro.product.chip").contains("u")) {
			sscActivity.findViewById(R.id.linearlayout_factory_ssc_u_miuenable).setVisibility(View.GONE);
			sscActivity.findViewById(R.id.linearlayout_factory_ssc_u_miumodulation).setVisibility(View.GONE);
			sscActivity.findViewById(R.id.linearlayout_factory_ssc_u_miupercentage).setVisibility(View.GONE);
			sscActivity.findViewById(R.id.linearlayout_factory_ssc_u_lvdsenable).setVisibility(View.GONE);
			sscActivity.findViewById(R.id.linearlayout_factory_ssc_u_lvdsmodulation).setVisibility(View.GONE);
			sscActivity.findViewById(R.id.linearlayout_factory_ssc_u_lvdspercentage).setVisibility(View.GONE);
		}
	}
	...
	public boolean onCreate() {
		...
		if (factoryManager.getPanelSwing() == 1) {
			factoryManager.setPanelSwing((short) 40);
		}
