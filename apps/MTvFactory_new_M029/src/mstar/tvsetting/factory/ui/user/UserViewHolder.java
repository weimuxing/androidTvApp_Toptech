...
public class UserViewHolder {
	...
	public void findView() {
		...
		if(mUserActivity.isM029()){
			linearlayout_user_dtv_preset.setVisibility(View.GONE);
		}
	...
	public void setScrollingDisplayStatus() {
		if (SystemProperties.getBoolean("persist.sys.onidaview_onoff", false)) {
			...
			intent.setAction("close_onidaview");//RootActivity receiver
	...
	public void onCreate() {
		...
		if(mUserActivity.isM029()){
			mStr_Initial_channel = mUserActivity.getResources().getStringArray(R.array.str_arr_user_initial_channel_m029);
		} else {
