...
package com.mstar.android.tv.tunersetup.channel;
...
import com.mstar.android.tv.tunersetup.dtv.lnb.dvb.LnbOptionActivity;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_MENU:
                Intent intent = new Intent(TvIntent.ACTION_TUNER_SETUP);
