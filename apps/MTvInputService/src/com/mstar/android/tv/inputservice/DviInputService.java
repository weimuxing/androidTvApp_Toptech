 ...
 * DviInputService
 */
public class DviInputService extends BaseTvInputService {
    private static final String TAG = "DviInputService";

    @Override
    public Session onCreateSession(String inputId) {
        Log.d(TAG, "onCreateSession: inputId = " + inputId);
        if (WindowControl.acquireWindow(inputId)) {
            return new DviSessionImpl(this, inputId);
        } else {
            return null;
        }
    }
    ...
    public TvInputInfo onHardwareAdded(TvInputHardwareInfo hardwareInfo) {
        if (hardwareInfo.getType() != TvInputHardwareInfo.TV_INPUT_TYPE_DVI) {
            return null;
        }
        Log.d(TAG, "onHardwareAdded: deviceId = " + hardwareInfo.getDeviceId());
        ComponentName name = new ComponentName(this, DviInputService.class);
    ...
    static class DviSessionImpl extends SessionImpl {
        DviSessionImpl(Context context, String inputId) {
