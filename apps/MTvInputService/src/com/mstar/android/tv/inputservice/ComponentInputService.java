...
/**
 * ComponentInputService
 */
public class ComponentInputService extends BaseTvInputService {
    private static final String TAG = "ComponentInputService";

    @Override
    public Session onCreateSession(String inputId) {
        Log.d(TAG, "onCreateSession: inputId = " + inputId);
        if (WindowControl.acquireWindow(inputId)) {
            return new ComponentSessionImpl(this, inputId);
        } else {
            return null;
        }
    }
    ...
    public TvInputInfo onHardwareAdded(TvInputHardwareInfo hardwareInfo) {
        ...
        ComponentName name = new ComponentName(this,ComponentInputService.class);
    ...
    static class ComponentSessionImpl extends SessionImpl {
        ComponentSessionImpl(Context context, String inputId) {
