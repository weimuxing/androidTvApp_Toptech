...
/**
 * CompositeInputService
 */
public class CompositeInputService extends BaseTvInputService {
    private static final String TAG = "CompositeInputService";

    @Override
    public Session onCreateSession(String inputId) {
        Log.d(TAG, "onCreateSession: inputId = " + inputId);
        if (WindowControl.acquireWindow(inputId)) {
            return new CompositeSessionImpl(this, inputId);
        } else {
            return null;
        }
    }
    ...
    public TvInputInfo onHardwareAdded(TvInputHardwareInfo hardwareInfo) {
        if (hardwareInfo.getType() != TvInputHardwareInfo.TV_INPUT_TYPE_COMPOSITE) {
            return null;
        }
        Log.d(TAG, "onHardwareAdded: deviceId = " + hardwareInfo.getDeviceId());
        ComponentName name = new ComponentName(this, CompositeInputService.class);
    ...
    static class CompositeSessionImpl extends SessionImpl {
        CompositeSessionImpl(Context context, String inputId) {
