 ...
 * SvideoInputService
 */
public class SvideoInputService extends BaseTvInputService {
    private static final String TAG = "SvideoInputService";

    @Override
    public Session onCreateSession(String inputId) {
        Log.d(TAG, "onCreateSession: inputId = " + inputId);
        if (WindowControl.acquireWindow(inputId)) {
            return new SvideoSessionImpl(this, inputId);
        } else {
            return null;
        }
    }
    ...
    public TvInputInfo onHardwareAdded(TvInputHardwareInfo hardwareInfo) {
        if (hardwareInfo.getType() != TvInputHardwareInfo.TV_INPUT_TYPE_SVIDEO) {
            return null;
        }
        Log.d(TAG, "onHardwareAdded: deviceId = " + hardwareInfo.getDeviceId());
        ComponentName name = new ComponentName(this, SvideoInputService.class);
    ...
    static class SvideoSessionImpl extends SessionImpl {
        SvideoSessionImpl(Context context, String inputId) {
