 ...
 * ScartInputService
 */
public class ScartInputService extends BaseTvInputService {
    private static final String TAG = "ScartInputService";

    @Override
    public Session onCreateSession(String inputId) {
        Log.d(TAG, "onCreateSession: inputId = " + inputId);
        if (WindowControl.acquireWindow(inputId)) {
            return new ScartSessionImpl(this, inputId);
        } else {
            return null;
        }
    }
    ...
    public TvInputInfo onHardwareAdded(TvInputHardwareInfo hardwareInfo) {
        if (hardwareInfo.getType() != TvInputHardwareInfo.TV_INPUT_TYPE_SCART) {
            return null;
        }
        Log.d(TAG, "onHardwareAdded: deviceId = " + hardwareInfo.getDeviceId());
        ComponentName name = new ComponentName(this, ScartInputService.class);
    ...
    static class ScartSessionImpl extends SessionImpl {
        ScartSessionImpl(Context context, String inputId) {
