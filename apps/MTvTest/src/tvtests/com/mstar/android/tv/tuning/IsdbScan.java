...
public class IsdbScan extends TvScanBase {

    private static final String TAG = "IsdbScan";

    static IsdbScan mInstance = null;
     ...
     */
    public static IsdbScan getInstance() {
        /* Double-checked locking */
        if (mInstance == null) {
            synchronized (IsdbScan.class) {
                if (mInstance == null) {
                    mInstance = new IsdbScan();
                }
            }
        }
        return mInstance;
