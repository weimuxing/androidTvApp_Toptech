...
public class EpgTest extends TestBase {

    private static final String TAG = "EpgTest";

    private TvEpgManager mTvEpgManager;

    private final int DTV_CHANNEL_EPG_RF = 22;

    //FIXME: use Dtmb as an example, may need to refine middleware test case later
    ...
    public void setUp() throws Exception {
        super.setUp();
        // setup country for tuning
        mTvChannelManager.setSystemCountryId(TvCountry.UK);
    ...
    public void testEpgAbc() {
        Log.d(TAG, "test epg test case sample");
    }
    ...
    private int checkDtvChannelCount() {
        ...
        if (dtvChCount < 2) {
            mDtmbScan.setDtvManualScanRf(DTV_CHANNEL_EPG_RF);
            mDtmbScan.doDtvManualScan();
