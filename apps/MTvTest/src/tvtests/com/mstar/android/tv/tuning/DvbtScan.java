...
public class DvbtScan extends TvScanBase {

    private static final String TAG = "DvbtScan";

    static DvbtScan mInstance = null;
    ...
    // dtv scan rf channel
    private static final int DTV_SCAN_RF_CH = 32;
     ...
     */
    public static DvbtScan getInstance() {
        /* Double-checked locking */
        if (mInstance == null) {
            synchronized (DvbtScan.class) {
                if (mInstance == null) {
                    mInstance = new DvbtScan();
                }
            }
        }
        return mInstance;
