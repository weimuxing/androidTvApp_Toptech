...
public class DvbcScan extends TvScanBase {

    private static final String TAG = "DvbtScan";

    static DvbcScan mInstance = null;
    ...
    protected DvbcScan() {
        ...
        mDvbcRouteIndex = mTvChannelManager.getSpecificDtvRouteIndex(TvChannelManager.TV_ROUTE_DVBC);
    }
     ...
     */
    public static DvbcScan getInstance() {
        /* Double-checked locking */
        if (mInstance == null) {
            synchronized (DvbcScan.class) {
                if (mInstance == null) {
                    mInstance = new DvbcScan();
                }
            }
        }
        return mInstance;
    ...
    public void doDtvAutoScan() {
        ...
        TvDvbChannelManager.getInstance().setDtvAntennaType(mDvbcRouteIndex);

        TvChannelManager.DvbcScanParam sp = mTvChannelManager.new DvbcScanParam();
        mTvChannelManager.dvbcgetScanParam(sp);
        // FULL SCAN
        mTvChannelManager.setDvbcScanParam(sp.u16SymbolRate, sp.QAM_Type,
