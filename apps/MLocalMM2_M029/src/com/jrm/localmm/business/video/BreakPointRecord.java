...
public class BreakPointRecord {
	 ...
	 * @return
	 */
	public static int getData(String path, String size, Context context) {
		if (dbAdapter == null) {
	 ...
	 * @param context
	 */
	public static void addData(String path, int time, String size, Context context) {
		if(time < 0){
			return;
		}
		if (dbAdapter == null) {
	...
	{
	    return context.getSharedPreferences("breakpoint", Context.MODE_PRIVATE).getBoolean("needBreakpoint", true);
	}

	public static void setBreakPointFlag(Context context, boolean flag)
    {
