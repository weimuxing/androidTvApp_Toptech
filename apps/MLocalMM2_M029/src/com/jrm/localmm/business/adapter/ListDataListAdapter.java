...
public class ListDataListAdapter extends BaseAdapter {
	private LayoutInflater mInflater;
	private ViewHolder holder;
	private String[] optionData;

	public ListDataListAdapter(Context context, String[] optionData) {
		try {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		if (convertView == null) {
			...
			holder.settingOptionTextViewNo = (TextView) convertView
					.findViewById(R.id.videolist_no);
		...
		holder.settingOptionTextViewNo.setText(position+1+".");
		return convertView;
	}

	static class ViewHolder {
		TextView settingOptionTextView;
		TextView settingOptionTextViewNo;
	}
}
