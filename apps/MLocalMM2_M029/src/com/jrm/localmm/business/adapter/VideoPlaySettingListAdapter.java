...
import com.jrm.localmm.ui.video.VideoPlaySettingDialog;
...
public class VideoPlaySettingListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        if (convertView == null) {
            ...
            if (position == Tools.ITEM_TRACK_SETTING||position == Tools.ITEM_VOIDE_MODE_SETTING) {
        ...
        //Log.d("skk", "position="+position+"   settingName"+settingData[position]+"  settingOption"+optionData[position]);
        return convertView;
    }
