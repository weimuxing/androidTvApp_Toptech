 ...
 * @date 2012-3-16
 */
public class AudiosListAdapter extends BaseAdapter {
    private ArrayList<BaseData> musicList;
    private int currentPosition;
    private Activity activity;

    public AudiosListAdapter(Activity activity, ArrayList<BaseData> musicList,
            int currentPosition) {
        super();
