    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.iconImage = (ImageView) convertView
                    .findViewById(R.radio_selection_mode_list_item.iconImage);
            holder.nameText = (TextView) convertView
                    .findViewById(R.radio_selection_mode_list_item.nameText);
            holder.formatText = (TextView) convertView
                    .findViewById(R.radio_selection_mode_list_item.formatText);
            holder.descriptionText = (TextView) convertView
                    .findViewById(R.radio_selection_mode_list_item.descriptionText);
