...
public class PhotoInfoDialog extends Dialog {
     ...
     * Structure function.
     */
    public PhotoInfoDialog(Activity activity, int theme, BaseData photoFile) {
...
//        this.cancel();
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Point point = new Point();
       // display.getSize(point);
        ...
        int height = (int) (display.getHeight() * 0.38);
    ...
    private void findViews() {
        ...
        mResolution = (TextView) findViewById(R.id.resolution_val);
    }
    ...
    private void updatePhotoInfo() {
        if (mPhotoFile != null) {
            ...
            // size of photo
            mFileSize.setText(mPhotoFile.getSize());
            // format of photo, such as .png
            mFileFormat.setText(mPhotoFile.getFormat());
            mResolution.setText(getFileResolution(mPhotoFile.getPath()));
            long modifiedTime = mPhotoFile.getModifyTime();
    ...
    public static String getFileResolution(String sPath) {
    	Bitmap bt  = BitmapFactory.decodeFile(sPath, null); 
    	if(bt == null) return null;
        return bt.getWidth()+"X"+bt.getHeight();
    }
}
