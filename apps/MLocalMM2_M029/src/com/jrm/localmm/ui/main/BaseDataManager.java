...
public class BaseDataManager {
    ...
    // data container
    private MediaContainerApplication mediaContainer = null;
                ...
                if (f.isDirectory()) {
                    ...
                    if (check(name, resource.getStringArray(R.array.photo_filter))) {
                        ...
                        // other file
                    		...
                    		resource.getStringArray(R.array.install_filter))){
                    	file.setType(Constants.FILE_TYPE_INSTALL);
                    }else{
     ...
     * Cache Data.
     */
    private void putAllToCache(final int type, final List<BaseData> src) {
        // sort data
