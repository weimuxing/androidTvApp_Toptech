...
public class NetVideoPlayHolder {
    ...
    public boolean processRightKey(int keyCode, KeyEvent event) {
        switch (NetVideoPlayActivity.state) {
            case NetVideoPlayActivity.OPTION_STATE_PRE:
                NetVideoPlayActivity.state =NetVideoPlayActivity.OPTION_STATE_REWIND;
            ...
            case NetVideoPlayActivity.OPTION_STATE_PLAY:
                NetVideoPlayActivity.state = NetVideoPlayActivity.OPTION_STATE_WIND;
    ...
    public void SetVideoTimeSelect(boolean bSelect) {
        if (bSelect) {
            ...
            bt_videoTime
                    .setBackgroundResource(R.drawable.player_icon_time_focus);
        } else {
    ...
    public void SetVideoWindSelect(boolean bSelect) {
        if (bSelect) {
            ...
            bt_videoWind
                    .setBackgroundResource(R.drawable.player_icon_wind_focus);
        } else {
    ...
    public void SetVideoRewindSelect(boolean bSelect) {
        if (bSelect) {
            ...
            bt_videoRewind
                    .setBackgroundResource(R.drawable.player_icon_rewind_focus);
        } else {
