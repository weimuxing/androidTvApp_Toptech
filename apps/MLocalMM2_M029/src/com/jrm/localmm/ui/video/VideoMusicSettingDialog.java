...
public class VideoMusicSettingDialog extends Dialog {
	private static final String TAG = "VideoMusicSettingDialog";
	...
	public VideoMusicSettingDialog(VideoPlayerActivity context, VideoPlaySettingDialog videoPlaySettingDialog) {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode==KeyEvent.KEYCODE_ENTER&&music_eq.isFocused()) {
			mVideoMusicEQSettingDialog = new VideoMusicEQSettingDialog(mContext,VideoMusicSettingDialog.this);
			mVideoMusicEQSettingDialog.show();
			this.dismiss();
		}
