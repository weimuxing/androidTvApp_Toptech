...
public class DetailInfoDialog extends Dialog {
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
		//add by fangcuihong,20160720
    	if(keyCode==KeyEvent.KEYCODE_INFO ||keyCode == KeyEvent.KEYCODE_DPAD_LEFT
                        ||keyCode == KeyEvent.KEYCODE_DPAD_RIGHT ||keyCode == KeyEvent.KEYCODE_ENTER){ //huzhou 20160628 modify
			flag=false;
			this.cancel();
		}else {
			num=15;
