...
public class VideoMusicEQSettingDialog extends Dialog {
	private static final String TAG = "VideoVideoSettingDialog";
	private VideoPlayerActivity mmContext;
	//private VideoMusicEQSettingDialog mVideoMusicEQSettingDialog;
	...
	public VideoMusicEQSettingDialog(VideoPlayerActivity context,VideoMusicSettingDialog mvideoMusicSettingDialog) {
		super(context, R.style.dialog);
		mmContext = context;
		mVideoMusicSettingDialog = mvideoMusicSettingDialog;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (metrics.density == 1.5) {
			...
			height = (int) (display.getHeight() * 0.68);
		}
	...
	public class MyAdapter extends BaseAdapter {
		...
		public MyAdapter(Context context, int[] settingData, VideoMusicEQSettingDialog mMusicEQSettingDialog) {
			try {
