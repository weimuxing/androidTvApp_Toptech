...
public class ThumbnailViewHolder {
    ...
    private void initViews() {
        mMultiThumbnailLayout = (LinearLayout)mActivity.findViewById(R.id.main_thumbnail_layout);
        ...
        mThumbnailTimePositionView = (ImageView) mActivity.findViewById(R.id.thumbnail_time_position_view);

        mThumbnailBorderLine = new ImageView[2];
        mThumbnailBorderLine[0] = (ImageView) mActivity.findViewById(R.id.thumbnail_topline);
        mThumbnailBorderLine[1] = (ImageView) mActivity.findViewById(R.id.thumbnail_bottomline);
    }
