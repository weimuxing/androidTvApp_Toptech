...
public class MusicPlayerListener {
    ...
    public static final int OPTION_STATE_SET = 0x8;
    // playMode
    ...
    protected void addMusicListener() {
        ...
        mMusicPlayerViewHolder.bt_MusicSetting
        .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MusicPlayerActivity.state = OPTION_STATE_SET;
                registerListeners();
            }
        });
    }
    ...
    protected void drapLeft() {
        ...
        case OPTION_STATE_PRE:
            ...
            mMusicPlayerViewHolder.bt_MusicSetting.setFocusable(true);
            mMusicPlayerViewHolder.bt_MusicSetting.requestFocus();
            mMusicPlayerViewHolder.bt_MusicSetting
                    .setBackgroundResource(R.drawable.player_icon_setting_foucs);
            break;
        ...
        case OPTION_STATE_LIST:
            ...
            if (playMode == SINGE) {
                mMusicPlayerViewHolder.bt_MusicCir
                        .setBackgroundResource(R.drawable.player_icon_singles_focus);
            } else if (playMode == REPEAT) {
                mMusicPlayerViewHolder.bt_MusicCir
        ...
        case OPTION_STATE_INFO:
            ...
            mMusicPlayerViewHolder.bt_MusicList
                    .setBackgroundResource(R.drawable.player_icon_list_focus);
            break;
        case OPTION_STATE_SET:
            MusicPlayerActivity.state = OPTION_STATE_INFO;
            mMusicPlayerViewHolder.bt_MusicSetting.setFocusable(false);
            mMusicPlayerViewHolder.bt_MusicSetting
                    .setBackgroundResource(R.drawable.player_icon_setting);
            mMusicPlayerViewHolder.bt_MusicInfo.setFocusable(true);
            mMusicPlayerViewHolder.bt_MusicInfo.requestFocus();
            mMusicPlayerViewHolder.bt_MusicInfo
                    .setBackgroundResource(R.drawable.player_icon_infor_focus);
            break;
        }
    }
