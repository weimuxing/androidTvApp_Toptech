...
public class DTVAutoTuneOptionActivity extends MstarBaseActivity {
    ...
    private String fre_unit = " MHz";
    private String sys_unit = " Bps";
    ...
    private void initUIComponents() {
        ...
        if (dvbcDtvRouteIndex == currentDtvRouteIndex) {
            mComboBtnTitle = new ComboButton(this, getResources().getStringArray(
                ...
                public void doUpdate() {
                    ...
                    //ImageView modulationImage = (ImageView) findViewById(R.id.imageview_cha_dtvautotuning_button_tips_modulation);
                   // TextView modulationText = (TextView) findViewById(R.id.textview_cha_dtvautotuning_button_tips_modulation);
                    ImageView symbolImage = (ImageView) findViewById(R.id.imageview_cha_dtvautotuning_button_tips_symbol);
                    TextView symbolText = (TextView) findViewById(R.id.textview_cha_dtvautotuning_button_tips_symbol);
                    ImageView networkidImage = (ImageView) findViewById(R.id.imageview_cha_dtvautotuning_button_tips_networkid);
                    TextView networkidText = (TextView) findViewById(R.id.textview_cha_dtvautotuning_button_tips_networkid);
                    ...
                    if (0 == mComboBtnTitle.getIdx()) {
                        ...
                        //mComboBtnModulation.setVisibility(View.INVISIBLE);
                        mComboBtnSymbol.setVisibility(View.INVISIBLE);
                        mComboBtnNetworkId.setVisibility(View.INVISIBLE);
                        frequencyImage.setVisibility(View.GONE);
                        frequencyText.setVisibility(View.GONE);
                       // modulationImage.setVisibility(View.GONE);
                       // modulationText.setVisibility(View.GONE);
                        symbolImage.setVisibility(View.GONE);
                        symbolText.setVisibility(View.GONE);
                        networkidImage.setVisibility(View.GONE);
                        networkidText.setVisibility(View.GONE);
                    } else {
                       ...
                       // mComboBtnModulation.setVisibility(View.INVISIBLE);
                        mComboBtnSymbol.setVisibility(View.VISIBLE);
                        mComboBtnNetworkId.setVisibility(View.VISIBLE);
                       ...
                       // modulationImage.setVisibility(View.GONE);
                        ...
                        networkidImage.setVisibility(View.VISIBLE);
                        networkidText.setVisibility(View.VISIBLE);
                    }
                }
            };
        ...
        mComboBtnFrequency = new ComboButton(this,null, R.id.linearlayout_cha_dtvautotuning_fre,
            ...
            @Override
            public void doUpdate() {
            	Log.d("pan_next","freupdate");
                if (mComboBtnFrequency.getIdx() < 0) {
                    mComboBtnFrequency.setIdx(FREQUENCY_MAX,fre_unit);
                }
                if (mComboBtnFrequency.getIdx() > FREQUENCY_MAX){
                    mComboBtnFrequency.setIdx(0,fre_unit);
                }
            }
        };
/*
 ...
 */
        ...
        mComboBtnSymbol = new ComboButton(this, null, R.id.linearlayout_cha_dtvautotuning_sym, 1,
            ...
            public void doUpdate() {
                if (mComboBtnSymbol.getIdx() < 0) {
                    mComboBtnSymbol.setIdx(SYMBOL_MAX,sys_unit);
                }
                if (mComboBtnSymbol.getIdx() > SYMBOL_MAX) {
                    mComboBtnSymbol.setIdx(0,sys_unit);
                }
            }
        };
    ...
    private void loadDataToUI() {
        ...
        if (true == mIsModulationAuto) {
        	Log.d("pan_next","modulation_true");
        ...
        if (true == mIsSymbolAuto) {
        	Log.d("pan_next","sysbolauto_true");
            mDvbcSymbol = 0;
        ...
        if (TvChannelManager.CABLE_OPERATOR_STOFA == mDvbcOperator
            ...
            mComboBtnNetworkId.setTextInChild(2, getResources().getString(R.string.str_cha_dtvautotuning_auto));
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_PROG_BLUE:
                ...
                if (true == mIsFrequencyAuto) {
                	Log.d("pan_next","blue_freauto_true");
                    mIsFrequencyAuto = false;
                    mComboBtnFrequency.setIdx(0,fre_unit);
                    mComboBtnFrequency.setEnable(true);
                	...
                	Log.d("pan_next","blue_freauto_false");
                    mIsFrequencyAuto = true;
                    mComboBtnFrequency.setTextInChild(2, getResources().getString(R.string.str_cha_dtvautotuning_auto));
                    mComboBtnFrequency.setEnable(false);
                }
            ...
            case KeyEvent.KEYCODE_PROG_GREEN:
                // symbol
            	//add by pan for disable the green
                if (0 == mComboBtnTitle.getIdx()) {
                    return true;
                }
               //add end 
            ...
            case KeyEvent.KEYCODE_PROG_YELLOW:
                // network id
            	//add by pan for disable the yellowkey
                if (0 == mComboBtnTitle.getIdx()) {
                    return true;
                }
                //add end
            ...
            case KeyEvent.KEYCODE_9:
                switch (currentid) {
                    case R.id.linearlayout_cha_dtvautotuning_fre:
                        inputFrequencyNumber(keyCode - KeyEvent.KEYCODE_0,fre_unit);
                        break;
                    case R.id.linearlayout_cha_dtvautotuning_sym:
                        inputSymbolNumber(keyCode - KeyEvent.KEYCODE_0,sys_unit);
                        break;
    ...
    private void inputFrequencyNumber(int inputNumber,String unit) {
        int freq = 0;
        ...
        mComboBtnFrequency.setIdx(mDvbcFrequency ,unit);
    }

    private void inputSymbolNumber(int inputNumber,String unit) {
        short symbol = 0;
        ...
        mComboBtnSymbol.setIdx(mDvbcSymbol , unit);
    }
