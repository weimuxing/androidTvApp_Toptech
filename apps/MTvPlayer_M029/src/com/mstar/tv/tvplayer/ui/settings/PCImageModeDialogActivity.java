...
public class PCImageModeDialogActivity extends MstarBaseActivity {
                ...
                myBtnBack.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                      //  TvPictureManager.getInstance().execAutoPc();
						if (TvPictureManager.getInstance().execAutoPc()) 
						{					
							Toast.makeText(activity,R.string.str_pic_pcimagemode_success,Toast.LENGTH_SHORT).show();					
						}
						else 
						{					
							Toast.makeText(activity,R.string.str_pic_pcimagemode_failed,Toast.LENGTH_SHORT).show();		
						}		
                        LoadDataToDialog();
                    }
                });
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		handler.sendEmptyMessage(8888);//modify by hz 20170910
