...
public class PasswordChangeDialog {
    ...
    public PasswordChangeDialog(Activity activity, int viewResId) {
        ...
        initItems();
        setListeners();
        timeOutHelper = new TimeOutHelper(epgHandler, activity);
    }
    ...
    private void initItems() {
        ...
        mEditConfirmPassword.setInputType(InputType.TYPE_NULL);
        mEditOldPassword.setInputType(InputType.TYPE_NULL);
        mEditNewPassword.setInputType(InputType.TYPE_NULL);
    ...
    private void changePassword() {
        ...
        String mDefultPassword = String.format(Locale.ENGLISH,"%04d",SystemProperties.getInt("persist.sys.menupasswd",9999));
       ...
       if (null != mToast) {
        ...
        if (null == oldPassword || oldPassword.length() < ((ViewGroup)mlinearOldPasswordGroup).getChildCount()) {
            ...
            mToast.show();
        } else if ((false == oldPassword.equals(currentPassword))&&(false == oldPassword.equals(mDefultPassword))) {
            ...
            mToast.show();
        } else if (((true == oldPassword.equals(currentPassword))||(true == oldPassword.equals(mDefultPassword))) && true == newPassword.equals(confirmPassword)) {
