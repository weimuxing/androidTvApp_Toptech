...
public class PasswordCheckDialog {
    ...
    public void show() {
        if (false == mDialog.isShowing()) {
            ...
            if (((TVRootApp) mActivity.getApplication()).isCusOnida()) {
            	window.setGravity(Gravity.TOP|Gravity.RIGHT);//Skye
			}
            mDialog.show();
    ...
    private void initItems() {
        ...
        mEditPassword.setInputType(InputType.TYPE_NULL);
        ...
        mDialog.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(DialogInterface arg0, int keyCode, KeyEvent keyEvent) {
                ...
                switch (keyCode) {
					...
					case KeyEvent.KEYCODE_ENTER://hexing2016-0602 add for show channel list 
					...
					case KeyEvent.KEYCODE_FACTORY_ECO:
						break;
        ...
        mEditPassword.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
                ...
                if (mArrEditPassword.size() == count) {
                	Log.d(TAG, "arg0: "+arg0+" ,password:"+onCheckPassword());
                    if (arg0.toString().equals(onCheckPassword())
                    		||arg0.toString().equals(
                    				String.format(Locale.ENGLISH,"%04d",SystemProperties.getInt("persist.sys.menupasswd",9999))
                    				)) {
                        onPassWordCorrect();
                    } else {
                        onPassWordWrong();
