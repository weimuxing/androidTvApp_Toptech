...
public class TeletextActivity extends MstarBaseActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        // }
        //zb20160104 add
        if ("TOPTECH_AT061".equals((SystemProperties.get("mstar.toptech.remote", "not-defined"))))
        {
			switch (keyCode) {
				case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
					keyCode=MKeyEvent.KEYCODE_MSTAR_UPDATE;
					break;
				case KeyEvent.KEYCODE_MEDIA_NEXT:
					keyCode=MKeyEvent.KEYCODE_MSTAR_HOLD;
					break;
				case KeyEvent.KEYCODE_MEDIA_REWIND:
					keyCode=MKeyEvent.KEYCODE_MSTAR_SIZE;
					break;
				case KeyEvent.KEYCODE_MEDIA_FAST_FORWARD:
					keyCode=MKeyEvent.KEYCODE_MSTAR_REVEAL;
					break;
				case MKeyEvent.KEYCODE_SUBTITLE:
					keyCode=MKeyEvent.KEYCODE_MSTAR_SUBCODE;
					break;
				}
        }
		//end
        switch (keyCode) {
            ...
            case MKeyEvent.KEYCODE_LIST:
                ...
                return true;
            case MKeyEvent.KEYCODE_MSTAR_SUBCODE:
                mTvChannelManager.sendTeletextCommand(TvChannelManager.TTX_COMMAND_SUBPAGE);
                return true;
            case MKeyEvent.KEYCODE_SUBTITLE:
                mTvChannelManager.sendTeletextCommand(TvChannelManager.TTX_COMMAND_SUBTITLE_NAVIGATION);
                return true;
        }
