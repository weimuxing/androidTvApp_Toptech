...
public class RecordActivity extends MstarBaseActivity {
    ...
    //add by jerry 20160527
    private boolean mIsModify = false;
    private int mOriginEventIndex = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((getIntent() != null) && (getIntent().getExtras() != null)) {
            ...
            int offsetTimeInS = mTvEpgManager.getEpgEventOffsetTime(baseTime, true);
            mEventBaseTime -= offsetTimeInS;
            ...
            mOriginEventIndex = getIntent().getIntExtra(Constant.EPG_INDEX_OF_EDITING_EVENT, -1);
                ...
                .setPositiveButton(R.string.str_epg_timer_delete_conflict_confirm,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (mIsModify) {//add by jerry 20160527
                                    if (mOriginEventIndex >= 0)
                                        mTvTimerManager.delEpgEvent(mOriginEventIndex);
                                }
    ...
    private void initialEpgTimerInfo() {
        ...
        if (true == mIsEventBasedRecording) {
            ...
            Log.d(TAG, "======>>>mEventTimerInfo.startTime sec " + mEventTimerInfo.startTime);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_ENTER:
                ...
                Log.d(TAG, "###mIsModify = "+mIsModify);
                Log.d(TAG, "###mOriginEventIndex = "+mOriginEventIndex);
                if (mIsModify) {//add by jerry 20160527
                    if (mOriginEventIndex >= 0)
                        mTvTimerManager.delEpgEvent(mOriginEventIndex);
                }
    ...
    private void updateRecordstartDate(){
    	mStartTime.month = mStartTime.month;
    	mStartTime.monthDay = mStartTime.monthDay;
        mTextStartMonthValue.setText(mStartTime.format("%m") + mStrMonth);
        mTextStartDateValue.setText(mStartTime.format("%d") + mStrDate);
    ...
    private void updateRecordendDate(){
    	mEndTime.month = mEndTime.month;
    	mEndTime.monthDay = mEndTime.monthDay;
    	mTextEndDateValue.setText(mEndTime.format("%d") + mStrDate);
        mTextEndMonthValue.setText(mEndTime.format("%m") + mStrMonth);
