...
public class ViewHolder {
    ...
    public ProgressBar loading_waiting;//skye1013
    ...
    public TextView text_cha_atvmanualtuning_store_channelno_val;
    ...
    public void findViewForDtvManualTuning() {
        ...
        loading_waiting = (ProgressBar)dtvmanualtune.findViewById(R.id.loading_waiting);//skye1013
    }
    ...
    public void findViewForPALAtvManualTuning() {
    	text_cha_atvmanualtuning_store_channelno_val = (TextView) mPALAtvManualTune
                .findViewById(R.id.textview_cha_atvmanualtuning_store_channelno_val);
